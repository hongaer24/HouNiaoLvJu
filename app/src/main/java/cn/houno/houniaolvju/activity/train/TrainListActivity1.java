...
public class TrainListActivity1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setWindowStatusBarColor(TrainListActivity1.this, R.color.app_theme_green);
        initView();
        initData();
        initEvent();
    ...
    private void initEvent() {
        exListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                for(int i=0;i<trainTicketList.size();i++){
                    if(i!=groupPosition){
            ...
            public void onSuccess(final String result) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        Toast.makeText(TrainListActivity1.this, obj.getString("msg"), Toast.LENGTH_SHORT).show();
    ...
    private void parseData(String result) {
        ...
        try {
            ...
            trainTicketList = gson.fromJson(jsonStr, new TypeToken<List<TrainTicketBean>>() {}.getType());
    ...
    private class MyHandler extends Handler {
        ...
        public MyHandler(TrainListActivity1 activity) {
        ...
        public void handleMessage(Message msg) {
            if (msg.arg1 == REQUEST_SUCCESS) {
                ...
                if (trainTicketList != null && trainTicketList.size() > 0) {
                    listAdapter = new ExpandableAdapter(TrainListActivity1.this, trainTicketList, date);

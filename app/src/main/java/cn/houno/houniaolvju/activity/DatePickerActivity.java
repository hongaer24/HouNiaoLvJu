...
public class DatePickerActivity extends Activity implements OnDaySelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setWindowStatusBarColor(DatePickerActivity.this,R.color.app_theme_green);

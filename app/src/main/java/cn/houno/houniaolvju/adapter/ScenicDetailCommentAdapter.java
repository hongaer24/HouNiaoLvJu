...
import cn.houno.houniaolvju.bean.ScenicDetailBean.DataBean.CommentBean.CommentDataBean;
...
public class ScenicDetailCommentAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<CommentDataBean> mDatas;

    public ScenicDetailCommentAdapter(Context context, List<CommentDataBean> mDatas) {
        mContext = context;
        this.mDatas = mDatas;
        mInflater = LayoutInflater.from(context);
    }

    public void setDatas(List<CommentDataBean> datas) {
        mDatas = datas;

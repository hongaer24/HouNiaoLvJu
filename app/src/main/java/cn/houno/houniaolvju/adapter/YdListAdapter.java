...
import cn.houno.houniaolvju.bean.YdListBean.DataBean;
...
public class YdListAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private List<DataBean> mDatas;

    public YdListAdapter(Context context, List<DataBean> datas) {
        mDatas = datas;
        mContext = context;

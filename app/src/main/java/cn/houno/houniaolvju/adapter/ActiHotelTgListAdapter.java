 ...
 * 修改备注：
 */
public class ActiHotelTgListAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflate;
    private List<ActiHotelTgListBean.DataBean> mList;

    public ActiHotelTgListAdapter(Context context) {
        mContext = context;
        mInflate = LayoutInflater.from(context);
    }

    public ActiHotelTgListAdapter(Context context, List<ActiHotelTgListBean.DataBean> list) {
        mContext = context;
        mList = list;
        mInflate = LayoutInflater.from(context);
    }

    public void setData(List<ActiHotelTgListBean.DataBean> list) {
        mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.flLabel = (FrameLayout) convertView.findViewById(R.id.fl_hotel_label);

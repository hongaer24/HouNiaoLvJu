 ...
 * 修改备注：
 */
public class Border2TextView extends TextView {
    ...
    public Border2TextView(Context context) {
        this(context, null);
    }

    public Border2TextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Border2TextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 读取属性值
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.Border2TextView);
        strokeWidth = ta.getDimensionPixelSize(R.styleable.Border2TextView_strokeWidth, strokeWidth);
        cornerRadius = ta.getDimensionPixelSize(R.styleable.Border2TextView_cornerRadius, cornerRadius);
        strokeColor = ta.getColor(R.styleable.Border2TextView_strokeColor, Color.TRANSPARENT);
        mFollowTextColor = ta.getBoolean(R.styleable.Border2TextView_followTextColor, true);
        ta.recycle();
